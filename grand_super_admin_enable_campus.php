...
$conn->query("update admins set status='1' WHERE campus_id = $id");



// Now disable the campus related teachers
$conn->query("UPDATE teachers SET status='1' WHERE campus_id = $id");


$_SESSION['success'] = "Campus its admin and its teachers has been enabled!";
header("Location: grand_super_admin_campuses.php");
exit;
?>
